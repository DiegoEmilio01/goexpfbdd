...
func runSufVarVar(t *testing.T, id int, tc test.BTRecord, neg bool) {
	...
	var f test.Encodable = suf.VarVar{I1: x, I2: y}
	if neg {
		f = logop.Not{Q: f}
	}
